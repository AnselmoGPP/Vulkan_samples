...
void VulkanEnvironment::initWindow()
{
	...
	//glfwSetWindowUserPointer(window, this);								// loopManager has been set as windowUserPointer
	//glfwSetFramebufferSizeCallback(window, framebufferResizeCallback);	// This callback has been set in loopManager
