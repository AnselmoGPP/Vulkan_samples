...
VkImageView HelloTriangleApp::createImageView(VkImage image, VkFormat format) 
{
	...
	viewInfo.subresourceRange.aspectMask		= VK_IMAGE_ASPECT_COLOR_BIT;			// Image's purpose and which part of it should be accessed. Here, our images will be used as color targets without any mipmapping levels or multiple layers. 
